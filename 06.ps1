...
Write-Log "--- ApacheAvro Update | CVE-2024-47561 | Machine: $env:COMPUTERNAME ---"
...
# Backup
$backupDir = "C:\Temp\ApacheAvro_backup_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
